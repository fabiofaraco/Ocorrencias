		...
		<div class="container">
			<form id="frm" name="frm" method="post">
				...
				<div class="panel panel-default">
				  <div class="panel-heading"><h2>Cadastro de Usuários</h2></div>
				  <div class="panel-body">
				  	...
				  	<hr>
				  	<button id="btnSalvar" type="button" class="btn btn-cadastro col-xs-12 col-sm-4 col-sm-offset-4">Salvar</button>
				  </div>
				</div>
